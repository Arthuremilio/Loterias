...
begin
  ...
  begin
    edtQtdNumeros.SetFocus;
    raise Exception.Create('Escolha uma quantidade de números para gerar um jogo!');
  end;

  if Trim(edtQtdJogos.Text).IsEmpty then
  begin
    edtQtdJogos.SetFocus;
    raise Exception.Create('Determine a quantidade de jogos que você deseja gerar!');
  end;
end;
